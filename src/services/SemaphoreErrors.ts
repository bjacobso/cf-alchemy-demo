...
export class SemaphoreRejectedError extends Data.TaggedError("SemaphoreRejectedError")<{
  key: string;
  reason: string;
}> {}

export class SemaphoreReleaseError extends Data.TaggedError("SemaphoreReleaseError")<{
  key: string;
  permitId: string;
  message: string;
}> {}
