...
export const WarehouseConfirmation = DurableDeferred.make("warehouse-confirmation", {
  success: Schema.Struct({
...
export const OrderWorkflowLive = OrderWorkflow.toLayer((payload) =>
  Effect.gen(function* () {
    ...
    console.log(`Warehouse confirmed, ship date: ${confirmation.estimatedShipDate}`);
